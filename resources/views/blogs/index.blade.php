        ...
        <div class="rounded-lg w-full p-3 bg-white ring-offset-0 ring-0 shadow-lg">
            @if ($blogs->count() > 0)
                @for ($i = 0; $i<count($blogs); $i++)
                    <a href="{{'blogpost/'}}{{$blogs[$i]->id}}/{{$blogs[$i]->title}}" class="w-full my-2 hover:opacity-75">
                        ...
                        <div>
                            ...
                            @endif
                            <a href="{{'blogpost/'}}{{$blogs[$i]->id}}/{{$blogs[$i]->title}}" class="hover:underline"><i class="fa fa-book-reader m-1"></i>Read Now</a></p>
                        </div>
        ...
        <div class="w-full md:w-2/6 p-2 md:h-screen md:float-right md:ml-auto">
            ...
            @for ($k=0; $k < count($recent); $k++)
                <div class="bg-white rounded-lg mb-3 ring-offset-0 ring-0 shadow-lg ">   
                    <a href="{{'blogpost/'}}{{$recent[$k]->id}}/{{$recent[$k]->title}}" class="block w-full hover:opacity-70">
                        ...
                        <div>
                            ...
                            @endif
                            <a href="{{'blogpost/'}}{{$recent[$k]->id}}/{{$recent[$k]->title}}" class="inline hover:underline"><i class="fa fa-book-reader m-1"></i>Read Now</a></p>
                        </div>
