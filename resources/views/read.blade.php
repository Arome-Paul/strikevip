        ...
        <div class="w-full md:w-3/4">
            <div class="rounded-lg w-full p-3 bg-white ring-offset-0 ring-0 shadow-lg">
                ...
                <div>
                    ...
                    <div class="pb-3">
                        <span class="block font-semibold w-full opacity-90"><i class="fa fa-user p-2"></i>Strike Media</span>
            ...
            <a href="{{route('blogs.post')}}" class="hover:underline text-blue-600 hover:text-blue-800 my-2 font-semibold">Read More</a>
        </div>
    </div>
